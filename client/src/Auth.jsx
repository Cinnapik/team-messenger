...
export default function Auth({ onAuth }) {
  ...
  const [color, setColor] = useState("#3ea8ff");
  ...
  return (
    <div style={{ width: 420 }}>
      <div className="panel">
        ...
        <p className="small">Лёгкая локальная авторизация. Имя и цвет сохраняются в localStorage.</p>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 8 }}>
          <label className="small">Цвет</label>
